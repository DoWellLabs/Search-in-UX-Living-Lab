                                ...
                                child: GestureDetector(
                                  ...
                                  child: EmailWidget(
                                    ...
                                    query: _model.queryDropdownValue == null ||
                                        ...
                                        ? _model.googleMapsCenter1?.toString()
                                        : _model.queryDropdownValue,
                  ...
                  child: Container(
                    ...
                    child: Stack(
                      children: [
                        ...
                        if ((_model.locationDropdownValue != null &&
                                _model.locationDropdownValue != '') &&
                            (_model.sliderRadius2Value != null))
                            ...
                            builder: (context, snapshot) {
                              ...
                              return Container(
                                ...
                                child: custom_widgets.LivingLabMap(
                                  width: double.infinity,
                                  height: double.infinity,
                                  radius: _model.sSliderRadiusValue!,
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return Builder(builder:
                                                                          ...
                                                                          return FlutterFlowGoogleMap(
                                                                            ...
                                                                            onCameraIdle: (latLng) =>
                                                                                setState(() => _model.googleMapsCenter2 = latLng),
                                                                  ...
                                                                  child: FutureBuilder<
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return FlutterFlowDropDown<
                                                                          String>(
                                                                        controller: _model
                                                                            .queryDropdownValueController ??= FormFieldController<
                                                                                String>(
                                                                            null),
                                                                        options: (GetCategoriesCall.categories(
                                                                          queryDropdownGetCategoriesResponse
                                                                              .jsonBody,
                                                                        ) as List)
                                                                            .map<String>((s) => s.toString())
                                                                            .toList()!,
                                                                  ...
                                                                  child: FutureBuilder<
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return FlutterFlowDropDown<
                                                                          String>(
                                                                        controller: _model
                                                                            .locationDropdownValueController ??= FormFieldController<
                                                                                String>(
                                                                            null),
                                                                        options: (GetCitiesCall.citiesName(
                                                                          locationDropdownGetCitiesResponse
                                                                              .jsonBody,
                                                                        ) as List)
                                                                            .map<String>((s) => s.toString())
                                                                            .toList()!,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if ((FFAppState().refreshed != true) &&
                                ...
                                Container(
                                  width:
                                      MediaQuery.sizeOf(context).width * 0.965,
                                  height: 300.0,
                                  decoration: BoxDecoration(
                                    color: Color(0xFFD4FFE6),
                                  ),
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            return FlutterFlowDropDown<
                                                              ...
                                                              onChanged:
                                                                  (val) async {
                                                                setState(() =>
                                                                    _model.sLocationDropdownValue1 =
                                                                        val);
                                                                setState(() {
                                                                  FFAppState()
                                                                          .locationName =
                                                                      _model
                                                                          .sLocationDropdownValue1!;
                                                                });
                                                              },
                                                              width: MediaQuery
                                                                          .sizeOf(
                                                          ...
                                                          builder: (context,
                                                            ...
                                                            return FlutterFlowDropDown<
                                                              ...
                                                              onChanged:
                                                                  (val) async {
                                                                setState(() =>
                                                                    _model.sLocationDropdownValue2 =
                                                                        val);
                                                                setState(() {
                                                                  FFAppState()
                                                                          .locationName =
                                                                      _model
                                                                          .sLocationDropdownValue2!;
                                                                });
                                                              },
                                                              width: MediaQuery
                                                                          .sizeOf(
                                                              ...
                                                              if (getJsonField(
                                                                ...
                                                                if ((_model
                                                                  ...
                                                                  _model.nearby =
                                                                      await GetNearbyLocationsCall
                                                                          .call(
                                                                    placeIdsList: (GetNearbyLocationsIdCall
                                                                            .iDsList(
                                                                  ...
                                                                  if ((_model
                                                                      ...
                                                                      true)) {
                                                                    if (!functions
                                                                        .isListEmpty(GetNearbyLocationsCall.locationList(
                                                                      (_model.nearby
                                                                              ?.jsonBody ??
                                                                          ''),
                                                                    )!
                                                              ...
                                                              onPressed:
                                                                ...
                                                                if ((getJsonField(
                                                                  ...
                                                                  _model.lF25 =
                                                                    ...
                                                                    destinations: functions.joinCoords((GetNearbyLocationsCall
                                                                            .coordinates(
                                                                      (_model.locationsResult
                                                                              ?.jsonBody ??
                                                                          ''),
                                                                            ...
                                                                            distances: functions.joinLists(
                                                                                (CalculateDistanceCall.distance(
                                                                                  (_model.lF25?.jsonBody ?? ''),
                                                                                    ...
                                                                                    ?.toList(),
                                                                                (CalculateDistanceCall.distance(
                                                                                  (_model.lN25?.jsonBody ?? ''),
                                                                                ) as List)
                                                                                    .map<String>((s) => s.toString())
                                                                                    .toList()
                                                                                    ?.toList(),
                                                                                (CalculateDistanceCall.distance(
                                                                                  (_model.lL25?.jsonBody ?? ''),
                                                                                ) as List)
                                                                                    .map<String>((s) => s.toString())
                                                                                    .toList()
                                                                                    ?.toList())!,
                                  ...
                                  onPressed: () async {
                                    setState(() {
                                      _model.sQueryDropdownValueController
                                          ?.reset();
                                      _model.sLocationDropdownValueController2
                                          ?.reset();
                                    });
                                    setState(() {
                            ...
                            FlutterFlowIconButton(
                              ...
                              onPressed: () async {
                                ...
                                if (getJsonField(
                                  ...
                                  _shouldSetState = true;
                                  if ((_model
                                          .locationsIdResultCopy?.succeeded ??
                                      true)) {
                                    _model.locationsResultCopy =
                                        await GetNearbyLocationsCall.call(
                                      placeIdsList:
